...
class Trie{
    ...
    Trie(){
        root = new Node();// Write your code here.
    }
                          ...
                          node->put(c, new Node());
                                ...
                                node = node->get(c);
                                      node->increasePrefix();
                                        ...
                                        node->increaseEnd();  // Write your code here.
    }
                  ...
                  if (!node->containsKey(c))
                          return 0;
                                        ...
                                        node = node->get(c);
                                                ...
                                                return node->getEnd();// Write your code here.
    }
                  ...
                  if (!node->containsKey(c))
                          return 0;
                                        ...
                                        node = node->get(c);
                                                ...
                                                return node->getPrefixes();// Write your code here.
    }
                          ...
                          return;
                                ...
                                node = node->get(c);
                                      node->decreasePrefix();
                                                  ...
                                                  node->decreaseEnd();// Write your code here.
    }
};
